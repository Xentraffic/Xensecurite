...
function SocialClickEvent(){var anchors=document.getElementsByTagName('a');var sharelink='';var _popupW='640';var _popupH='380';for(var i=0;i<anchors.length;i++){var anchor=anchors[i];
// if(anchor.className.indexOf('fb_btn')+1){anchor.onclick=function(){var _fbURL='https://www.facebook.com/sharer/sharer.php?u='+sharelink;var _fbTTL='TIP OF THE WEEK: How this little device saves you from THOUSANDS of dollars spent at crooked repair shops...';PopupCenter(_fbURL,_fbTTL,_popupW,_popupH);}}
...
window.onload=function(){SocialClickEvent();}});window.onscroll=function(){scrollFunction()};function scrollFunction(){
